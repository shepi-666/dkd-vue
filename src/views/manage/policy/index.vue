<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="policyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" width="50px" type="index" align="center" prop="policyId" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" @click="getDetialInfo(scope.row)" v-hasPermi="['manage:vm:list']">查看详情</el-button>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="policyRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="策略方案" prop="discount">
          <el-input-number :precision="0" :min="1" :max="100" v-model="form.discount" placeholder="输入正整数" />%
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <!-- 策略详情对话框 -->
     <el-dialog title="策略详情" v-model="openDetail" width="500px" append-to-body>
      <el-form-item label="策略名称" :style="{'font-weight':'bold'}" prop="policyName">
        <span>{{ form.policyName }}</span>
      </el-form-item>
      <label> 包含设备 </label>
